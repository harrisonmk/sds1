...
import axios from 'axios'; //ele que faz a ponte com o back end
...
const CreateRecord = () => {
    ...
    const handleSubmit = () => {
        ...
        }).catch(() => Alert.alert('Erro ao salvar informacoes!'))
        ...
        <>
            ...
            <View style={styles.container}>
                ...
                <TextInput style={styles.inputText}
                           placeholder="Nome" placeholderTextColor="#9E9E9E" onChangeText={text => setName(text)}
                value={name}
                />
                ...
                <TextInput style={styles.inputText}
                           ...
                           placeholder="Idade" placeholderTextColor="#9E9E9E" onChangeText={text => setAge(text)}
                value={age}
                />
